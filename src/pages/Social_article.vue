<template>
          ...
          <div class="Fb-post-category-container-X">
            ...
            <div class="Fb-post-write-X"><a href="#">寫文章</a></div>
                    ...
                    <div class="Fb-Atricle-X">
                        ...
                        <p>環保觀念深植國人心中，為了我們愛護的自然資源與地球環境，除了做好資源回收外，還有哪些可以採取的環保行動呢？本篇整理了 10 個日常生活中常見的環保例子，讓大家可以透過這些案例，學習如何更加善待我們的地球。<br/>
                        ...
                        <img src="https://picsum.photos/600/400.jpg" alt="">
    ...
    <!-- 點擊評論按鈕才會出現的遮罩+框 -->
    <div class="Fb-comment-cover-X"> <!-- 這是遮罩 -->
        <div class="m-box"> <!-- 這是框 -->
            <img src="https://picsum.photos/id/240/200/300" alt="">
            <div class="inner-box">
