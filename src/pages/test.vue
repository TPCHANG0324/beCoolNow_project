...
function create3DHTML() {
  ...
  div.innerHTML = `
    <div class="be-cool-now-container" style="display:none;">
      <a href="/"><div class="be-cool-now-button be-cool-now-front-btn">前台</div></a>
      <div class="be-cool-now-logo">
        <img src="${logoImage}" alt="涼城即時 Be Cool Now LOGO" />
      </div>
      <a href="/tid103/g1/IcB_article"><div class="be-cool-now-button be-cool-now-back-btn">後台</div></a>
    </div>
  `;
