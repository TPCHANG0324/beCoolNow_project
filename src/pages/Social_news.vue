  ...
  <div class="Fb-post-article-X" :class="{ active: !RWDnews }">
    ...
    <section>
      ...
      <article v-for="(data, index) in datas" :key="index" @click="goToArticle(index)">
        ...
        <div class="Fb-post-article-right-X" v-if="data.image">
    ...
    <!-- 頁數 --> <!-- 使用:key="activeItem" 強制讓頁數顯示再跑一次 -->
    <Paginator :key="activeItem" :currentPage="currentPage" :totalPages="totalItemCount"
...
//計算頁數 //一頁五則文章
const currentPage = ref(1);  //當前頁碼，預設 1
...
const articles = ref([
  ...
  },
  {
    ...
    content: '台大風險中心舉辦「2024台灣公正轉型調查發布」記者會，針對淨零排放、氣候變遷雙主軸，對全國18歲以上民眾，在17日到25日使用室內電話、行動電話2種電話訪問調查，有效樣本1102份，以95%信賴度估計，抽樣誤差在正、負2.95個百分點之內。',
    handup: 100,
    chat: 100,
    image: ''
  },
  ...
  },
  {
    ...
    content: '根據統計，全球每年浪費掉的食物約為 13 億公噸，是生產量的 3 分之 1，而每噸廚餘經過掩埋處理，會產生約 221.35 公斤二氧化碳、14.7 公斤甲烷，總計每年為了處理廚餘，就製造高達 44 億噸的溫室氣體。',
    handup: 100,
    chat: 100,
    image: ''
  },
