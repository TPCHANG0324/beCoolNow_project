...
<template>
    <div class=" wrapper">
         ...
         <div class="expandable" id="extraCards">
             <!-- 卡片容器 -->
             <div class="daily_card">
                 <!-- 卡片範例 7 -->
                 <div class="AcB_card">
     ...
     <div class="learn_more" id="learnMoreBtn">
         <a href="#">Learn More</a>
     </div>
 
     <div class="collapse_section hidden">
         <button class="btnclose" id="collapseBtn">收合</button>
     </div>
         ...
         <div class="letter-form-container">
             <form class="letter-form">
                 ...
                 <div class="form-group">
                     ...
                     <input type="text" id="name_Ac" placeholder="請輸入您的姓名">
                 </div>
