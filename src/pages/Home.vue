    ...
    <section>
      <article class="Fp_disasterIce_H">
        <article class="Fp_textContent_H leftBlock">
          <h1>極地融冰</h1>
          <p>
            極地冰川因全球暖化加速消失，導致海水面上升、生態失衡。北極冰層減少威脅極地動物生存，南極冰架崩解影響全球氣候循環，突顯減碳與環保行動的重要性。
          </p>
        </article>
      </article>
    ...
    <section class="Fp_globalWarming_H">
      ...
      <article>
        <section class="Fp_textContent_H">
          <h2>什麼是全球暖化 ?</h2>
          <span>
            科學家將 20 世紀中葉以來的全球暖化趨勢歸因於人為加劇的「溫室效應」— 即大氣層截留地球向太空輻射的熱量，導致氣溫上升。<br /><br />其影響包括極地冰川融化、海水面上升、極端天氣事件增多、生態系統失衡以及物種滅絕。<br /><br />暖化改變了全球氣候循環，造成乾旱、洪水和颱風等自然災害的頻率與強度上升，威脅人類居住環境和糧食安全。
          </span>
        </section>
        <section class="Fp_textContent_H">
          <h2>造成的影響</h2>
          <span>
            全球氣候變遷已非是未來的問題，而是當下正在發生的危機。人類排放的溫室氣體增加，使地球氣候發生劇變，導致冰川與冰蓋的縮減、河川與湖泊的結冰期縮短、生物棲息地變遷，植物開花期的提前。
          </span>
        </section>
        <section class="Fp_textContent_H">
          <h2>暖化的證據</h2>
          <span>
            科學家長期預測的結果，如海冰消融、海水面加速上升，海洋酸化，以及更長、更強烈的熱浪，現已成為現實，並持續加劇全球環境的變遷。
          </span>
        </section>
      </article>
    </section>
    ...
    <section class="Fp_carbonData_H ">
      <div>
        <article class="Fp_textContent_H">
          <h2>二氧化碳 上升</h2>
          <p>
            大氣中的二氧化碳是一種溫室氣體，導致地球溫度變暖。人類活動在不到 200 年的時間內，使大氣中的 CO₂ 含量增加了 50%。圖表顯示自 1958 年以來，美國國家海洋暨大氣總署（NOAA）在夏威夷茂納羅亞天文台測量的大氣 CO₂ 濃度變化。
          </p>
        </article>
    ...
    <section class="Fp_tempData_H ">
      <div>
        <article class="Fp_textContent_H">
          <h2>全球溫度 上升</h2>
          <p>
            在 2024 年，地球平均地表溫度比 19 世紀末工業化前高出 2.65 華氏度（1.47 攝氏度），創下 1880 年有記錄以來的最高值。這顯示了全球暖化加劇，而主要的原因為溫室氣體排放增加所導致。
          </p>
        </article>
    ...
    <section class="Fp_iceData_H ">
      <div>
        <article class="Fp_textContent_H">
          <h2>冰層 減少</h2>
          <p>
            自 2002 年以來，NASA GRACE 衛星監測顯示，南極洲與格陵蘭冰層持續消融，每年流失達 4200 億噸冰量。這些冰蓋儲存全球三分之二的淡水，自 1993 年以來，來自這些冰蓋的融水約佔全球平均海水面上升的三分之一。
          </p>
        </article>
    ...
    <section class="Fp_seaLevelData_H ">
      <div>
        <article class="Fp_textContent_H">
          <h2>海水面 上升</h2>
          <p>
            全球暖化導致冰層減少，以及海水的升溫膨脹進而推動海水面的上升。衛星數據顯示，自 1993 年以來，海水面仍然持續的上升，且近年來的上升速度甚至超過過去 2,500 年的任何一個時期。
          </p>
        </article>
