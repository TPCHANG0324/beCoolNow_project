<template>
  <div>
    ...
    <transition name="fade">
      <BackStageSmallPopup class="IcB_eduAddPopup_H" v-if="isAddPopupVisible">
        <span>
          <p>教育影片&nbsp;新增</p>
    ...
    <transition name="fade">
      <BackStageSmallPopup class="IcB_eduEditPopup_H" v-if="isEditPopupVisible">
        <span>
          <p>教育影片&nbsp;編輯</p>
          <i class="fa-solid fa-x" @click="closePopup"></i>
        </span>
    ...
    <transition name="fade">
      <BackStageConfirmPopup class="IcB_eduDeletePopup_H" v-if="isDeletePopupVisible">
        <span></span>
        <div>
          <h3>確定將此影片刪除嗎?</h3>
          <div>
