            ...
            <div class="Sp-wrapper-X">
                ...
                <section class="Sp-shopping-reminder-X">
                    ...
                    <div class="Sp-shopping-reminder-body">感謝您支持我們的環保商品！以下是您的訂單與出貨注意事項：
                        ...
                        若您選購了其他現貨商品，建議您與預購商品分開結帳，以便現貨能提前寄出。
                        📬 取貨注意事項：
                        若您選擇便利商店取貨，請確保「收件人姓名」與身分證一致，以免影響取件流程。
                        🔍 尺寸與材質說明：
                        杯子容量：350ml / 500ml / 750ml
                        材質：100%再生寶特瓶纖維 (rPET) + 天然纖維
                        耐熱程度：80°C（請避免直接加熱）
                        ❗ 特殊說明：
                        再生環保馬克杯為特殊客製化商品，非商品瑕疵，恕不接受退換貨。
                        若您有尺寸或其他需求疑慮，請於下單前確認商品規格。
                        如需重新訂製，需再等待2-3週生產期。
                        💳 付款方式：
